...
<dict>
  ...
  <array>
    ...
    <string>$HOME_DIR/대시보드서버.mjs</string>
  </array>
  <key>WorkingDirectory</key><string>$HOME_DIR</string>
  <key>RunAtLoad</key><true/>
  <key>KeepAlive</key><true/>
  <key>StandardOutPath</key><string>$HOME_DIR/logs/대시보드.out</string>
  <key>StandardErrorPath</key><string>$HOME_DIR/logs/대시보드.err</string>
...
# 열쇠말은 새 대시보드가 첫 요청 때 만든다. 뜰 때까지 잠깐 기다리며 요청을 보낸다
